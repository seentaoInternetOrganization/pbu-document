...
/***/ (function(module, exports, __webpack_require__) {
	...
	var PBUDocumentDataInit = function PBUDocumentDataInit(_ref) {
	  var docConfigUrl = _ref.docConfigUrl,
	      ...
	      subjectTotal = _ref.subjectTotal,
	      subjectDetail = _ref.subjectDetail,
	      onSearchTotalSubjects = _ref.onSearchTotalSubjects,
	      onSearchDetailSubjects = _ref.onSearchDetailSubjects,
	  ...
	  var docProps = {
	    ...
	    onSearchTotalSubjects: onSearchTotalSubjects,
	    onSearchDetailSubjects: onSearchDetailSubjects,
	    onRemovePage: onRemovePage,
	    totalPage: totalPage,
	    currentPage: currentPage
	  };

	  return _react2.default.createElement(_container2.default, _extends({ mode: _constants.MODE.DATA_INIT
	  }, docProps));
	};

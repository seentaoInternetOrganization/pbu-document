	    ...
	    function DataInit() {
	        ...
	        return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = DataInit.__proto__ || (0, _getPrototypeOf2.default)(DataInit)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
	            ...
	            if (_this.props.isDataInit) {
	                _this.props.onSave(currentPage, (0, _stringify2.default)(dataFinal), isBodyEmpty);
	            } else {
	                _this.props.onSave(currentPage, (0, _stringify2.default)(dataFinal), answerArea, isBodyEmpty);
	            }
	            ...
	            return _this.onSave() && _this.props.onAppendPage();
	                ...
	                var tagNodes = (0, _from2.default)(Array(totalPage).keys()).map(function (i) {
	                    ...
	                    return _react2.default.createElement(
	                        ...
	                        (0, _extends4.default)({ key: 'tag_' + i
	                            ...
	                            onClick: function onClick(e) {
	                                e.preventDefault();
	                                _this2.onSave() && onPageChange(i + 1);
	                            },
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            _button2.default,
	                            { className: _dataInit2.default.btn_save, type: 'primary', loading: loading, onClick: this.onSave },
	                            '\u4FDD\u5B58'
	                        )
	                    ),
	                    renderAnswerArea(),

...
/***/ (function(module, exports, __webpack_require__) {
	...
	var DocEditor = function DocEditor(_ref) {
	    ...
	    var renderTextareaItem = function renderTextareaItem(item, index) {
	        ...
	        return canEdit(item) ? _react2.default.createElement('textarea', { key: 'textarea_' + index + '_' + currentPage,
	            name: item.name,
	            style: style,
	            value: value,
	            onChange: function onChange(e) {
	        ...
	        }) : _react2.default.createElement('textarea', { key: 'textarea_' + index + '_' + currentPage,
	            name: item.name,
	            style: style,
	            value: value,
	            readOnly: 'readonly',

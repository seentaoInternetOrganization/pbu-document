(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("react"), require("prop-types"), require("antd/lib/spin/style"), require("antd/lib/spin"), require("whatwg-fetch"), require("antd/lib/radio/style"), require("antd/lib/radio"), require("antd/lib/checkbox/style"), require("antd/lib/checkbox"), require("antd/lib/select/style"), require("antd/lib/select"), require("antd/lib/popover/style"), require("antd/lib/popover"), require("antd/lib/button/style"), require("antd/lib/button"), require("antd/lib/table/style"), require("antd/lib/table"), require("classnames"));
	else if(typeof define === 'function' && define.amd)
		define(["react", "prop-types", "antd/lib/spin/style", "antd/lib/spin", "whatwg-fetch", "antd/lib/radio/style", "antd/lib/radio", "antd/lib/checkbox/style", "antd/lib/checkbox", "antd/lib/select/style", "antd/lib/select", "antd/lib/popover/style", "antd/lib/popover", "antd/lib/button/style", "antd/lib/button", "antd/lib/table/style", "antd/lib/table", "classnames"], factory);
	else if(typeof exports === 'object')
		exports["pbu-document"] = factory(require("react"), require("prop-types"), require("antd/lib/spin/style"), require("antd/lib/spin"), require("whatwg-fetch"), require("antd/lib/radio/style"), require("antd/lib/radio"), require("antd/lib/checkbox/style"), require("antd/lib/checkbox"), require("antd/lib/select/style"), require("antd/lib/select"), require("antd/lib/popover/style"), require("antd/lib/popover"), require("antd/lib/button/style"), require("antd/lib/button"), require("antd/lib/table/style"), require("antd/lib/table"), require("classnames"));
	else
		root["pbu-document"] = factory(root["react"], root["prop-types"], root["antd/lib/spin/style"], root["antd/lib/spin"], root["whatwg-fetch"], root["antd/lib/radio/style"], root["antd/lib/radio"], root["antd/lib/checkbox/style"], root["antd/lib/checkbox"], root["antd/lib/select/style"], root["antd/lib/select"], root["antd/lib/popover/style"], root["antd/lib/popover"], root["antd/lib/button/style"], root["antd/lib/button"], root["antd/lib/table/style"], root["antd/lib/table"], root["classnames"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE_91__, __WEBPACK_EXTERNAL_MODULE_92__, __WEBPACK_EXTERNAL_MODULE_94__, __WEBPACK_EXTERNAL_MODULE_95__, __WEBPACK_EXTERNAL_MODULE_101__, __WEBPACK_EXTERNAL_MODULE_110__, __WEBPACK_EXTERNAL_MODULE_111__, __WEBPACK_EXTERNAL_MODULE_112__, __WEBPACK_EXTERNAL_MODULE_113__, __WEBPACK_EXTERNAL_MODULE_114__, __WEBPACK_EXTERNAL_MODULE_115__, __WEBPACK_EXTERNAL_MODULE_137__, __WEBPACK_EXTERNAL_MODULE_138__, __WEBPACK_EXTERNAL_MODULE_139__, __WEBPACK_EXTERNAL_MODULE_140__, __WEBPACK_EXTERNAL_MODULE_141__, __WEBPACK_EXTERNAL_MODULE_142__, __WEBPACK_EXTERNAL_MODULE_145__) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _readonly = __webpack_require__(105);
	...
	var _main3 = __webpack_require__(146);
	...
	var PBUDocumentAnswer = function (_Component) {
	    (0, _inherits3.default)(PBUDocumentAnswer, _Component);

	    function PBUDocumentAnswer() {
	        var _ref;

	        var _temp, _this, _ret;

	        (0, _classCallCheck3.default)(this, PBUDocumentAnswer);

	        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
	            args[_key] = arguments[_key];
	        }

	        return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = PBUDocumentAnswer.__proto__ || (0, _getPrototypeOf2.default)(PBUDocumentAnswer)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
	            currentAccountTitle: null,
	            subjectVisible: false,
	            currentCopy: (0, _docUtils.firstCopy)(_this.props.visibleSheet)
	    ...
	    (0, _createClass3.default)(PBUDocumentAnswer, [{
	        key: 'componentDidMount',
	        value: function componentDidMount() {
	            this.setState({
	                currentCopy: (0, _docUtils.firstCopy)(this.props.visibleSheet)
	            });
	        }
	    }, {
	        ...
	        value: function componentWillReceiveProps(nextProps) {
	            this.setState({
	                currentCopy: (0, _docUtils.firstCopy)(nextProps.visibleSheet)
	            });
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            var _props = this.props,
	                docConfigUrl = _props.docConfigUrl,
	                docData = _props.docData,
	                visibleSheet = _props.visibleSheet,
	                ...
	                onConfigLoaded = _props.onConfigLoaded,
	            ...
	            return _react2.default.createElement(
	                'div',
	                { className: _main4.default.container },
	                _react2.default.createElement(_copyGroup2.default, { currentCopy: currentCopy,
	                    className: _main4.default.copy,
	                    visibleSheet: visibleSheet,
	                    selectedClsName: _main4.default.highlight,
	                    onCopyChange: this.onCopyChange }),
	                _react2.default.createElement(
	                    _main2.default,
	                    { className: _main4.default.main_container,
	                    ...
	                    _react2.default.createElement(_readonly2.default, (0, _extends3.default)({ showAnswer: true,
	    ...
	    return PBUDocumentAnswer;
	}(_react.Component);

	exports.default = PBUDocumentAnswer;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ReadOnly = function (_Component) {
	    (0, _inherits3.default)(ReadOnly, _Component);

	    function ReadOnly() {
	        (0, _classCallCheck3.default)(this, ReadOnly);
	        return (0, _possibleConstructorReturn3.default)(this, (ReadOnly.__proto__ || (0, _getPrototypeOf2.default)(ReadOnly)).apply(this, arguments));
	    }

	    (0, _createClass3.default)(ReadOnly, [{
	        key: 'componentDidMount',
	        value: function componentDidMount() {
	        ...
	        value: function render() {
	            var _props = this.props,
	                ...
	                showAnswer = _props.showAnswer,
	                highlightAnswer = _props.highlightAnswer,
	                activityId = _props.activityId;

	            //是否高亮显示此元素

	            var highlightItem = function highlightItem(item) {
	                var all = docData.all;


	                if (showAnswer && highlightAnswer) {
	            ...
	            //获取元素基础样式
	            var basicStyleOfItem = function basicStyleOfItem(item) {
	                var pos = item.pos;


	                var backgroundStyle = highlightItem(item) ? {
	                    background: '#FFFF80'
	                } : {};
	            ...
	            var renderNormalItem = function renderNormalItem(item, index) {
	                ...
	                var style = (0, _extends3.default)({}, basicStyleOfItem(item), {
	                    overflow: 'hidden',
	            ...
	            var renderTextareaItem = function renderTextareaItem(item, index) {
	                ...
	                if (!value && config[0].docType === _constants.DOC_TYPE.DEFAULT) {
	                    return null;
	                }
	                ...
	                return _react2.default.createElement('textarea', { key: 'readonly_' + index,
	                    style: style,
	                    value: value,
	                    readOnly: 'readonly'
	                });
	            ...
	            return _react2.default.createElement(
	                'div',
	                { className: _common2.default.outter, ref: 'docBG' },
	                _react2.default.createElement(
	...
	ReadOnly.propTypes = {
	     ...
	     */
	    highlightAnswer: _propTypes2.default.bool,
	    /**
	     * 要展示的联次，默认0, 0, 1, 2
	     */
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../node_modules/css-loader/index.js?modules&minimize&localIdentName=[local]__[hash:base64:5]!../node_modules/less-loader/index.js!./main.less", function() {
				var newContent = require("!!../node_modules/css-loader/index.js?modules&minimize&localIdentName=[local]__[hash:base64:5]!../node_modules/less-loader/index.js!./main.less");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".container__3dzMD{text-align:left;display:inline-block;line-height:1.5;overflow:hidden}.copy__2FEW7,.main_container__2-xF3{display:inline-block;float:left}.copy__2FEW7{vertical-align:top;left:0;width:50px;z-index:10;text-align:right;color:#000}.copy__2FEW7 button{background-image:linear-gradient(-180deg,#fafafa,#f4f4f4);border:1px solid #c1c1c1;margin-bottom:1px;-webkit-transition:all .3s ease-in-out;-moz-transition:all .3s ease-in-out;-ms-transition:all .3s ease-in-out;-o-transition:all .3s ease-in-out;transition:all .3s ease-in-out;width:30px;height:30px}.copy__2FEW7 .highlight__8R_iH,.copy__2FEW7 button:focus,.copy__2FEW7 button:hover{width:50px;height:30px}", ""]);

	// exports
	exports.locals = {
		"container": "container__3dzMD",
		"main_container": "main_container__2-xF3",
		"copy": "copy__2FEW7",
		"highlight": "highlight__8R_iH"
	};
